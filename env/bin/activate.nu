...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Volumes/NVME/VISUAL/PROGETTO/Project/flask-server/env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Volumes/NVME/VISUAL/PROGETTO/Project/flask-server/env/bin/deactivate.nu'
